...
class Index extends BusinessBase
{
    ...
    public function index(Request $request)
    {
        $module=[
            [
                'name'=>Redis::hget('globalConf','module1CoverName') ?? '酷享自驾',
                'subtext'=>json_decode(Redis::hget('globalConf','module1CoverWord'),true) ?? ['你想要的','都在这里'],
                'img'=>Redis::hget('globalConf','module1') ?? '/static/carImg/2020/8be594ba12b6.png',
                'href'=>'/v1/module1',
                'isNew'=>true,
            ],
            [
                'name'=>Redis::hget('globalConf','module2CoverName') ?? '尊享出行',
                'subtext'=>json_decode(Redis::hget('globalConf','module2CoverWord'),true) ?? ['专人专车','一应俱全'],
                'img'=>Redis::hget('globalConf','module2') ?? '/static/carImg/2020/3650457923e4.png',
                'href'=>'/v1/module2',
                'isNew'=>false,
            ],
            [
                'name'=>Redis::hget('globalConf','module3CoverName') ?? '急速摩托',
                'subtext'=>json_decode(Redis::hget('globalConf','module3CoverWord'),true) ?? ['追求极致','畅快淋漓'],
                'img'=>Redis::hget('globalConf','module3') ?? '/static/carImg/2020/b7ebcc68ab2c.png',
                'href'=>'/v1/module3',
                'isNew'=>false,
            ],
            [
                'name'=>Redis::hget('globalConf','module4CoverName') ?? '安心托管',
                'subtext'=>json_decode(Redis::hget('globalConf','module4CoverWord'),true) ?? ['追求极致','畅快淋漓'],
                'img'=>Redis::hget('globalConf','module4') ?? '/static/carImg/2020/f7ca9919164b.png',
                'href'=>'/v1/module4',
                'isNew'=>false,
            ],
            [
                'name'=>Redis::hget('globalConf','module5CoverName') ?? '精致车源',
                'subtext'=>json_decode(Redis::hget('globalConf','module5CoverWord'),true) ?? ['炫酷超跑','触手可及'],
                'img'=>Redis::hget('globalConf','module5') ?? '/static/carImg/2020/3ecbddf84db1.png',
                'href'=>'/v1/module5',
                'isNew'=>false,
            ],
            [
                'name'=>Redis::hget('globalConf','module6CoverName') ?? '超值长租',
                'subtext'=>json_decode(Redis::hget('globalConf','module6CoverWord'),true) ?? ['长期租赁','更多优惠'],
    ...
    public function createOrder(Request $request)
    {
        ...
        $insert=[
            ...
            'getCarWay'=>$getCarWay, 'getCarPlace'=>$getCarPlace,'priceCond1'=>$priceCond1 ?? 1,
